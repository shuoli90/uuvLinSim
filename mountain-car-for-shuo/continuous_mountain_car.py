...
class Continuous_MountainCarEnv(gym.Env):
    ...
    def __init__(self, goal_velocity = 0):
        ...
        self.steepness_vals = [0.0025, 0.0035]
        self.steepness_probs = [0.5, 0.5]
        self.POSNOISESTD = 0.001
        self.VELNOISESTD = 0.0001
    ...
    def reset(self):
        ...
        self.state = np.array([self.trueinitpos, 0])
        self.time = 0
    ...
    def step(self, action):
        ...
        self.true_state.append(np.array([self.state[0], self.state[1], self.truec, self.trued]))
        ...
        avg_pos = np.average(pred_poss, weights=normweights)
        avg_vel = np.average(pred_vels, weights=normweights)
